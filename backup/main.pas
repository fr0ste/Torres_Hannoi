  ...
  constructor TReadThread.Create(var ASource, ADestination, Aaux: TPilaTorre ; var AFileName: string);
    begin
      inherited Create(False);
      FreeOnTerminate := True;
      FSource := ASource;
    ...
    begin
      ...
      hiloLeerMovs := TReadThread.Create(pilaTorre1,pilaTorre3, pilaTorre2, archivoMovimientos);
      hiloLeerMovs.Start;
