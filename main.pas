...
type
  ...
  public
    ...
    FAuxiliary: TPilaTorre;

     FSource: TPilaTorre;
  constructor Create(ASource, ADestination, AAuxiliary: TPilaTorre);
  private
...
type
  ...
  public
    ...
    //procedure Apilar(var Pila: TPilaTorre; disco: TImgDisco);
  end;
...
constructor TMoveThread.Create(ASource, ADestination, AAuxiliary: TPilaTorre);
begin
...
begin
  ...
  ResolverTorresHanoi(N - 1, Origen, Auxiliar, Destino);
    ...
    hiloMoveDisco := TMoveThread.Create(Origen,Destino,Auxiliar);
...
begin
  ...
  for i := 0 to origen.GetCoordenadaY-Origen.GetContenedor.Top do
  ...
  begin
    ...
    if Origen.GetCoordenadaX < Destino.GetCoordenadaX then
    begin
    for j := 0 to Destino.GetCoordenadaX - Origen.GetCoordenadaX do
  //for i := 0 to 100 do
    begin
      ...
      Sleep(1);
       ...
       begin
         for j := Origen.GetCoordenadaX downto Destino.GetCoordenadaX do
           begin
           disco.posicionDisco(disco.Left-1, disco.top);
          Disco.Repaint;
           //Sleep(1);
...
begin
  ...
  Form1.ResolverTorresHanoi(1,pilaTorre1,pilaTorre3,pilaTorre2);
...
begin
  ...
  //Inicio Resolver el juego de las Torres de Hanoi de manera automatica
   //ShowMessage('si');
  Form1.MoverDisco(FSource,FDestination,FAuxiliary);
